...
class HybridCryptoSystem:
    ...
    def generate_asym_keys(self, private_path: str, public_path: str) -> tuple:
        """
        Generate asymmetric keys and save them
    ...
    def encrypt_file(self, input_path: str,
                    public_path: str, encrypted_path: str, 
        ...
        :param symmetric_path: path to symmetric_key
        """
        try:
            ...
            self.file_proc.write_file(symmetric_path, symmetric_key)
        except Exception as e:
